...
class Topic(models.Model):
    ...
    course = models.ForeignKey(Course,db_index=True, on_delete= models.DO_NOTHING)
...
class SubTopics(models.Model):
    ...
    author = models.ForeignKey(User, null=True, related_name="subtopics_author_id", blank=True, on_delete= models.DO_NOTHING)
